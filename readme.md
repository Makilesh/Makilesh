...
<!-- ═══════════════════ CONTRIBUTION SNAKE ═══════════════════ -->
<!--
  Snake animation is generated by .github/workflows/snake.yml (Platane/snk).
  It publishes snake.svg + snake-dark.svg to the `output` branch on a daily cron.
  Generated in THIS repo (Makilesh/readme1) and served from its `output` branch.
  The raw URLs below are absolute, so they keep working even if this README is
  later copied into github.com/Makilesh/Makilesh.
  Needs one manual run from the Actions tab to create `output` the first time.
-->
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Makilesh/readme1/output/snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Makilesh/readme1/output/snake.svg">
    <img src="https://raw.githubusercontent.com/Makilesh/readme1/output/snake.svg" alt="Contribution snake animation" width="100%">
  </picture>
</div>
...
<div align="center">
  ...
  <a href="https://instagram.com/_makilesh_">
