...
<!--
  ...
  NOTE: the workflow must live in the repo that serves this profile README
  (github.com/Makilesh/Makilesh), and needs one manual run from the Actions tab
  to create the `output` branch the first time.
-->
